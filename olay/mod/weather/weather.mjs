...
export class Olay_Weather extends Olay {
    ...
    ui = {
        ...
        description: document.querySelector('.mod .description'),
        temperature: document.querySelector('.mod .temperature'),
        temperaturereal: document.querySelector('.mod .temperature .real'),
        temperaturefeel: document.querySelector('.mod .temperature .feel'),
        wind: document.querySelector('.mod .wind'),
        windspeed: document.querySelector('.mod .wind .speed'),
        windgusts: document.querySelector('.mod .wind .gusts'),
        winddirectiontext: document.querySelector('.mod .wind .directiontext'),
        winddirectiondegrees: document.querySelector('.mod .wind .directiondegrees'),
        cloudcover: document.querySelector('.mod .cloudcover'),
        humidity: document.querySelector('.mod .humidity'),
        precipitation: document.querySelector('.mod .precipitation'),
        elevation: document.querySelector('.mod .elevation'),
        updatedon: document.querySelector('.mod .updatedon'),
        findcoords: document.querySelector('.findcoords'),
        findcoordsinput: document.querySelector('.findcoords input'),
        findcoordsresult: document.querySelector('.findcoords .result'),
    };
    ...
    endpoint_coords = 'https://geocoding-api.open-meteo.com/v1/search?name={query}&count=10&language=en&format=json';
    valid_temperature_units = ['celsius', 'fahrenheit'];
    valid_windspeed_units = ['kmh', 'ms', 'mph', 'kn'];
    ...
    async update_ui(init_continous = false) {
        const data = await fetchx('json', this.endpoint_weather);
        if (!data || data.error) {
    ...
    async querycoords() {
        ...
        const data = await fetchx('json', this.endpoint_coords.replace('{query}', query));
